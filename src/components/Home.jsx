    ...
    <div>
      ...
      <main className="main">
        <div className="presentation">
          ...
          <h2>Hamza Kilinc</h2>
          <p>
            Bonjour, étant préparation de mon BTS SIO à l'institution des Chartreux, je vous présente mon portfolio qui regroupe mes projets scolaires et personnels.<br />
